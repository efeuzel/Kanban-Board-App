package com.uzel.ppmtool.web;

import com.uzel.ppmtool.domain.Backlog;
import com.uzel.ppmtool.domain.Project;
import com.uzel.ppmtool.domain.ProjectTask;
import com.uzel.ppmtool.services.MapValidationErrorService;
import com.uzel.ppmtool.services.ProjectTaskService;
...
public class BacklogController {
    ...
    public ResponseEntity<List<ProjectTask>> getProjectBacklog(@PathVariable String backlog_id) {
        return new ResponseEntity<List<ProjectTask>>(projectTaskService.findBacklogById(backlog_id),
                HttpStatus.OK);
    }
